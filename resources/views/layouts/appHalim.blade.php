...
<body>
            ...
            <header>
                <div class="wrapper my-header">
                    ...
                    <nav class="my-nav">
                        ...
                        <ul class="menu">
                            <li><a href="{{ route('company') }}" style="font-family: roboto, 'sans-serif'">Perusahaan</a></li>
                            <li><a href="{{ route('wproduct') }}" style="font-family: roboto, 'sans-serif'">Produk</a></li>
                            <li><a href="{{ route('wnews') }}" style="font-family: roboto, 'sans-serif'">Berita</a>
                            </li>
                            <li><a href="{{ route('contact') }}" style="font-family: roboto, 'sans-serif'">Kontak</a></li>
                        </ul>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <ul class="footer-links">
                                            <li><a href="produk/pvc-additives">PVC Additives</a></li>
                                            <li><a href="produk/plywood-glue-and-adhesive">Plywood Glue &amp; Adhesive</a></li>
                                            <li><a href="produk/electroplating-chemical-product">Electroplating Chemical Product</a></li>
                                            <li><a href="produk/metal">Metal</a></li>
                                        </ul>
                                    </div>
                                    <div class="col-lg-4">
                                        <ul class="footer-links">
                                            <li><a href="produk/paint-ink-chemical-product">Paint / Ink Chemical Product</a></li>
                                            <li><a href="produk/ceramic-raw-material">Caramic Raw Material</a></li>
                                            <li><a href="produk/food-ingredient-products">Food Ingredient Products</a></li>
                                            <li><a href="produk/feed-additive-products">Feed Additive Products</a></li>
                                        </ul>
                                    </div>
                                    <div class="col-lg-4">
                                        <ul class="footer-links">
                                            <li><a href="produk/plastic-resin-compound-and-engineering-plastic">Plastic Resin / Compound And Engineering Plastic</a></li>
                                            <li><a href="produk/other-general-chemical-products">Other General Chemical Products</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-2">
                            <div class="footer-2">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <ul class="footer-links">
                                            <li><a href="{{ route('wnews') }}">Food</a></li>
                                            <li><a href="{{ route('wnews') }}">Non Food</a></li>
                                            <li><a href="{{ route('wnews') }}">Event</a></li>
                                            <li><a href="{{ route('wnews') }}">General</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
    ...
    <script type="text/javascript" src="{{ asset('js/my-search-id.js') }}"></script>
    ...
    <script src="{{ asset('static/chunks/75447db9cbe8f7c6e21d4a62f9c3255061bc3fa5.c423d562ef33141691b6.js')}}" async=""></script>
    <script src="{{ asset('static/chunks/c59b47b88a0bada765fd0efc29de47ead8db980a.6e6a4e9ad0918a97f225.js')}}" async=""></script>
    <script src="{{ asset('static/chunks/81c4ce50b723f646b96f6500f434461f8ef7e2a5.c130d5b80f46d4b22c5e.js')}}" async=""></script>
