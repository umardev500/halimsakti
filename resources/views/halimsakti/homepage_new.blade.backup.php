...
@endsection
@section('lang')
<div class="lang-item"><a href="{{ route('homepage') }}" style="text-decoration: none; color:black;">ID</a>
</div>
<div class="lang-item"><a href="{{ route('homepage_en') }}" style="text-decoration: none; color:black;">EN</a>
</div>
@endsection
@section('content')
        ...
        <div id="banner">
            <div class="swiper mySwiper">
                <div class="swiper-wrapper">
                    @foreach($slider as $s)
                    <div class="swiper-slide" style="background: linear-gradient(to right, rgba(26, 26, 26, 0.7), black);">
                        <div class="gradient-cover"></div>
                        <img src="{{ asset('image/slider' . '/' . $s->image) }}" class="imgSlider">
                        <div class="wrapper">
                            <div class="row">
                        ...
                        <div class="form-brosur">
                            ...
                            <div class="d-flex justify-content-center align-items-center" style="max-width:400px">
                                ...
                                <a href="{{ asset('image/pdfebrochure' . '/' . $e->link) }}" target="_blank" style="    width: 100%;
                                            ...
                                            font-weight: 700;
                                            font-size: 20px;
                                            letter-spacing: 1px; text-decoration: none; position: relative; left: 12px; top: 12px; text-align:center;"><svg style="position: relative; right: 3px; bottom: 2px;" stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
