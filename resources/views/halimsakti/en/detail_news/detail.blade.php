...
@section('css')
<style>
    #news-detail .wrapper .right .most-read .most-read-list{
        width: 100%;
    max-height: 300px;
    overflow-y: auto;
    }
...
@section('content')
            <div class="content null">
                <div id="news-detail">
                    <div class="wrapper">
                        @foreach($news as $n)
                        <h1 class="section-title">{{ $n->news_nama_eng }}</h1>

                        <div class="row">
                            <div class="col-lg-8 left">
                                <img src="{{ asset("image/news/" . $n->image) }}" alt="Prepared-Drinking Challenges and Opportunities Post Pandemic Covid-19" class="img-fluid mb-3" />
                                ...
                                <div class="most-read-list">
                                    @foreach($newsall as $na)
                                        ...
                                        <div class="most-read-item">
                                            <div class="left">
                                                <a href="{{ route('newsdetail_en' , $na->news_nama_eng_slug )  }}" style="text-decoration: none;">
                                                    <h2>{{ $na->news_nama_eng }}</h2>
                                                </a>
                                                <a href="{{ route('newsdetail_en' , $na->news_nama_eng_slug )  }}" style="text-decoration: none;">
                                                    <p>{!! $na->description_sub_eng !!}</p>
                                                </a>
                                            </div>
                                            <div class="right">
                                                <a href="{{ route('newsdetail_en' , $na->news_nama_eng_slug )  }}" style="text-decoration: none;">
