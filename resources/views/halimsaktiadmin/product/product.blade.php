...
<div class="content-wrapper" style="background: white;">
  ...
  <section class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
          <a href="{{ route('admproduct_add') }}">
            <button type="button" class="btn btn-success" style="border-radius: 2px 0px 0px 9px; background: black;">Add Product</button>
          </a>
          <div class="card">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      ...
                      <th>Image</th>
                      <th>Nama Produk</th>
                      <th>Nama Product En</th>
                      <th>Deskripsi Singkat</th>
                      <th>Deskripsi Singkat En</th>
                      <th>Deskripsi</th>
                      <th>Deskripsi En</th>
                      <th></th>
                    </tr>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{ $no }}</td>
                      <td>
                        <img class="img-thumbnail" src="{{ asset('image/product/'. $p->image) }}">
                        <span style="font-size: 0.8rem; color: #62200a"></span>
                      </td>
                      <td><p>{{ $p->product_nama }}</p></td>
                      <td><p>{{ $p->product_nama_eng }}</p></td>
                      <td><p>{{ $p->description_sub }}</p></td>
                      <td><p>{{ $p->description_sub_eng }}</p></td>
                      <td><p>{!! $p->description !!}</p></td>
                      <td><p>{!! $p->description_eng !!}</p></td>

                      <td><a href="{{ route('admproduct_edit', $p->id_product) }}" type="button" class="btn btn-info btn-sm">Edit</a> | <a href="{{ route('admproduct_delete', $p->id_product) }}" type="button" class="btn btn-danger btn-sm">Delete</a></td>
                    </tr>
                    <?php $no++ ?>
                    @endforeach
                  </tbody>
