      ...
      <div class="row">
        <div class="col-12">
          {{-- <a href="{{ route('ebrochure_add') }}">
            <button type="button" class="btn btn-success" style="border-radius: 2px 0px 0px 9px; background: black;">Add E-Brochure</button>
          </a> --}}
          <div class="card">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{ $no }}</td>
                      <td><p>{{ $c->name }}</p></td>
                      <td><p><a href="{{ "https://mail.google.com/mail/?view=cm&fs=1&to="  . $c->email}}" target="_blank" style="text-decoration: none; color: #870000;">{{ $c->email }}</a></p></td>
                      <td><p>{{ $c->phone }}</p></td>
                      <td><p>{{ $c->message }}</p></td>
