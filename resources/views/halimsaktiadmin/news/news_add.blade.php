...
<div class="content-wrapper" style="background: white;">
  ...
  <section class="content">
    <div class="row">
      <form action="{{ route('admnews_store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="col-md-12">
          <a href="{{ route('admnews') }}" class="btn btn-warning btn-sm" style="margin-bottom: 5px; border-radius: 20px 1px 10px;">
              ...
              <div class="row">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="" name="news_nama" value="{{ old('news_nama') }}" required>
                    </div>
                  </div>
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label>news_nama_eng</label>
                      <input type="text" class="form-control" placeholder="" name="news_nama_eng" value="{{ old('news_nama_eng') }}" required>
                    </div>
                  </div>
                  <div class="col-sm-12">
                    <div class="form-group">
